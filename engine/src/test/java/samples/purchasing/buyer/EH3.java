...
public class EH3 implements EventHandler {

	private static EH3 INSTANCE=new EH3();
	
	public static EH3 getInstance() {
		return(INSTANCE);
	}

	public boolean canHandle(Message mesg) {
		return (mesg.getContent() instanceof OutOfStock);
	}
	
	public void onMessage(ConversationContext context, Conversation session, Message mesg) {
		System.out.println("RECEIVED OUT OF STOCK");
	}
